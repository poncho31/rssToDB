<form action="?section=search" method="POST">
	<input type="text" name="entry" placeholder="Politician's name">
...
if (isset($_POST['submitEntry'])) {
	...
	$selectDescription = 
	'
	SELECT nom, titre, description, categorie date, lien, categorie FROM media where description like "%'. $entry .'%"  ORDER BY date
	';
...
$temp = 0;
    ...
    function array_max_r($arr) {
 	...
 	// echo "Nombre de mot avant : " .array_max_r($arCount);
